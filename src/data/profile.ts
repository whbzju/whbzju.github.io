...
export const writingHighlights = [
  {
    group: "Current AI products and agents",
    groupZh: "当前 AI 产品与 Agent",
    type: "Zhihu answer",
    typeZh: "知乎回答",
    title: "有没有大佬分享一下做 agent 时的一些经验？",
    href: "https://www.zhihu.com/question/1982512240482619481/answer/2048796907066208530",
    noteEn:
      "Recent thoughts on AI agent practice, product visibility, and building from concrete ideas.",
    note: "关于 AI Agent 实践、产品可见性，以及如何把具体想法做出来的近期回答。",
  },
  {
    group: "Current AI products and agents",
    groupZh: "当前 AI 产品与 Agent",
    ...
    noteEn:
      "A practical answer connecting AI agent engineering with Memex, local-first personal AI, and product building.",
  ...
  },
  {
    ...
    noteEn:
      "A product-engineering answer on why production agents need tools, permissions, validation, and application structure.",
  ...
  },
  {
    ...
    noteEn:
      "A Memex-adjacent answer on personal records, AI anxiety, memory, and agency.",
    note: "延伸 Memex 的产品理念，讨论个人记录、AI 焦虑、记忆和主体性。",
  },
  {
    group: "WeShop and commercial AIGC",
    groupZh: "WeShop 与商业 AIGC",
    type: "Zhihu column",
    typeZh: "知乎专栏",
    title: "电商数字模特生成技术实践分享",
    href: "https://zhuanlan.zhihu.com/p/621970429",
    noteEn:
      "The early technical practice note behind WeShop's e-commerce digital model work.",
    note: "WeShop 早期电商数字模特方向的技术实践记录。",
  },
  {
    group: "WeShop and commercial AIGC",
    groupZh: "WeShop 与商业 AIGC",
    ...
    href: "https://zhuanlan.zhihu.com/p/629144911",
    noteEn:
      "The WeShop beta launch note, with concrete e-commerce model and scene generation examples.",
    note: "WeShop beta 开放测试说明，包含电商换模特、换场景等具体例子。",
  },
  {
    group: "WeShop and commercial AIGC",
    groupZh: "WeShop 与商业 AIGC",
    ...
    href: "https://zhuanlan.zhihu.com/p/633513013",
    noteEn:
      "A launch-period reflection on AIGC products, user feedback, growth, and commercialization.",
    note: "关于 AIGC 产品、用户反馈、增长和商业化的发布期思考。",
  },
  {
    group: "WeShop and commercial AIGC",
    groupZh: "WeShop 与商业 AIGC",
    ...
    noteEn:
      "A high-signal answer on virtual try-on, AI models, and production constraints in e-commerce photography.",
  ...
  },
  {
    ...
    noteEn:
      "A WeShop-grounded answer on why AI applications struggle to move from demos into industry workflows.",
  ...
  },
  {
    ...
    noteEn:
      "A reflection on running WeShop as a remote AI product team.",
    note: "从团队 leader 视角记录 WeShop 全员远程协作一年的体感和组织判断。",
  },
  {
    group: "Generative models and multimodal AI",
    groupZh: "生成模型与多模态 AI",
    type: "Zhihu column",
    typeZh: "知乎专栏",
    ...
    noteEn:
      "A popular technical primer on diffusion models for readers entering image generation.",
  ...
  },
  {
    ...
    noteEn:
      "A technical-product discussion of ChatGPT from the perspective of application builders.",
  ...
  },
  {
    ...
    type: "Zhihu answer",
    typeZh: "知乎回答",
    title: "大语言模型中的涌现现象是不是伪科学？",
    href: "https://www.zhihu.com/question/587177332/answer/2921362654",
    noteEn:
      "A widely read answer on emergence, multimodal models, and experimental evidence.",
    note: "关于涌现、多模态模型和实验结果的高赞回答。",
  },
  {
    group: "Generative models and multimodal AI",
    groupZh: "生成模型与多模态 AI",
    type: "Zhihu answer",
    typeZh: "知乎回答",
    title: "如何评价 OpenAI 发布的视频生成模型 Sora？",
    href: "https://www.zhihu.com/question/644463888/answer/3397557704",
    noteEn:
      "An answer on video generation, DiT, scaling, and how to study Sora-like systems.",
    note: "关于视频生成、DiT、scaling 和 Sora 类系统学习资料的回答。",
  },
  {
    group: "Search, recommendation, and early ML",
    groupZh: "搜索推荐与早期机器学习",
    type: "Zhihu answer",
    typeZh: "知乎回答",
    ...
    noteEn:
      "A representative answer connecting user embedding with recommendation-system practice.",
  ...
  },
  {
    ...
    noteEn:
      "A practical answer on recommendation-system pitfalls from real business work.",
  ...
  },
  {
    ...
    type: "Zhihu answer",
    typeZh: "知乎回答",
    title: "如何评价 Airbnb 的 Real-time Personalization 获得 2018 KDD 最佳论文？",
    href: "https://www.zhihu.com/question/302288216/answer/530729525",
    noteEn:
      "A popular answer and paper reading note on real-time personalization.",
    note: "关于 Airbnb 实时个性化论文的高赞解读和推荐系统实践延展。",
  },
  {
    group: "Search, recommendation, and early ML",
    groupZh: "搜索推荐与早期机器学习",
    type: "Zhihu answer",
    typeZh: "知乎回答",
    title: "在做算法工程师的道路上，你掌握了什么概念或技术使你感觉自我提升突飞猛进？",
    href: "https://www.zhihu.com/question/436874654/answer/1806138992",
    noteEn:
      "A career and craft answer on search, recommendation, ads, and algorithm-engineer growth.",
    note: "关于搜索、推荐、广告和算法工程师成长路径的代表性回答。",
  },
  {
    group: "Search, recommendation, and early ML",
    groupZh: "搜索推荐与早期机器学习",
    type: "Zhihu column",
    typeZh: "知乎专栏",
    title: "电商直播流量分配算法优化总结",
    href: "https://zhuanlan.zhihu.com/p/157333568",
    noteEn:
      "A Mogujie-era practice note on traffic allocation algorithms for live commerce.",
    note: "蘑菇街时期关于电商直播流量分配算法迭代的实践总结。",
  },
  {
    group: "Search, recommendation, and early ML",
    groupZh: "搜索推荐与早期机器学习",
    type: "Zhihu column",
    typeZh: "知乎专栏",
    title: "强烈推荐一个播放几十万的 B 站机器学习 UP 主 shuhuai008",
    href: "https://zhuanlan.zhihu.com/p/83392214",
    noteEn:
      "A highly saved machine-learning learning-resource post, visible in Zhihu's top-voted list.",
    note: "知乎高赞机器学习学习资源推荐，也是早期机器学习内容里传播较广的一篇。",
  },
];
